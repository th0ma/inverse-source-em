"""
Test for train_classification_model.py

Checks:
- imports work
- script executes without crashing
- the imported main() from train_classification is called
"""
...
import train_classification_model as script
...
def test_script_runs_and_calls_main(patch_dependencies):
    ...
    assert dummy.called, "train_classification.main() was not called"
