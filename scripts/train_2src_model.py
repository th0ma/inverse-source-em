...
This script trains a multitask network that predicts the parameters of two
point sources:
- polar coordinates $\left(\rho_1,\\,\phi_1\right)$ and $\left(\rho_2,\\,\phi_2\right)$
- strengths $I_1$ and $I_2$

The model is trained on the full‑field dataset
$\left(E_r,\\,E_i,\\,H_r,\\,H_i\right)$ generated by the canonical surrogate
pipeline.

Run from the project root:
    python train_2src_model.py
"""
